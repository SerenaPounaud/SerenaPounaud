...
- :wheelchair: **Accessibilité web (WCAG, RGAA et éco-conception)**
- **Référencement naturel & Règles SEO**
- :lock: **Sécurité web (OWASP) + Sécurisation du backend & API**
- :rocket: **Optimisation des performances**
- :test_tube: **Tests logiciels**
- :electric_plug: **API REST**
- :clipboard: **Gestion de projet Agile (Scrum)**
...
- **Algorithmique & Architecture logicielle (MVC)**
